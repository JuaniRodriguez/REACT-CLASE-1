...
export function UncontrolledCheckbox(props) {
    ...
    return (
        <label>{props.name}<input type="checkbox" onChange={checkboxHandler} checked={checked}/></label>
...
export function CheckboxList(props) {
    ...
    const checkBoxList=items.map((item)=> <li><UncontrolledCheckbox initialValue={item[1]} name={item[0]}/></li>)
