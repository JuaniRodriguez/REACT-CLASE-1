...
export function MatchNombre(props) {
    ...
    return (
    <label>Match with {props.nombre} <input type="text" className={stateValue===props.nombre ? "input-match" : "input" } onChange={handleChange}  /></label>
    )
...
export function PasswordInput(props) {
    ...
    return (
    <label>Min length <input type="password" className={stateValue.length<props.minLength ? "input-match" : "input" } onChange={handleChange}  /></label>
    )
...
export function ValidationInput(props) {
    ...
    return (
    <label>validation <input type={props.isPassword} className={ !stateValue ? "input-match" : "input" } onChange={handleChange}  /></label>
    )
