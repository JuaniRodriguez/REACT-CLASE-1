...
export function Tarjeta(props) {
  ...
  }, props.nombre), /*#__PURE__*/React.createElement("span", null, props.titulo)));
}
/*
...
export function BlogPost(props) {
  ...
  }, props.titulo), /*#__PURE__*/React.createElement(Tarjeta, props.autor)), props.parrafos.split("\n").map((el, i) => /*#__PURE__*/React.createElement("p", {
...
<p className="post-paragraph">Hoy vi una ardilla.</p>
      ...
      <p className="post-paragraph">
        Creo que puede haber sido un perro, dado que en Argentina
         no hay ardillas.
      </p>
*/