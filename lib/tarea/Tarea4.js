...
export function CheckboxListWithState(props) {
  ...
  const itemsList = items.map(item => /*#__PURE__*/React.createElement("li", null, item[0], /*#__PURE__*/React.createElement(ControlledCheckbox, {
    value: item[1],
    onChange: () => setState({ ...state,
      [item[0]]: !item[1]
    })
  }), " "));
  return /*#__PURE__*/React.createElement("ul", null, itemsList);
}
/*
