...
export function MatchNombre(props) {
  ...
  return /*#__PURE__*/React.createElement("label", null, "Match with ", props.nombre, " ", /*#__PURE__*/React.createElement("input", {
    type: "text",
    className: stateValue === props.nombre ? "input-match" : "input",
...
export function PasswordInput(props) {
  ...
  return /*#__PURE__*/React.createElement("label", null, "Min length ", /*#__PURE__*/React.createElement("input", {
    type: "password",
    className: stateValue.length < props.minLength ? "input-match" : "input",
    onChange: handleChange
  }));
}
/*
...
export function ValidationInput(props) {
  ...
  function handleChange(event, value) {
    setStateValue(props.validation(event, value));
  }

  return /*#__PURE__*/React.createElement("label", null, "validation ", /*#__PURE__*/React.createElement("input", {
    type: props.isPassword,
    className: !stateValue ? "input-match" : "input",
    onChange: handleChange
  }));
}